...
owner = 'f1db'  # replace with the repository owner's username
repo = 'f1db'  # replace with the repository name
path = 'src/data/circuits'  # replace with the path to the folder within the repository
